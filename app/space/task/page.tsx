...
export default function Tasks() {
    return (
       <main className="flex min-h-screen flex-col justify-between">
          ...
          <aside
             id="default-sidebar"
             className="sidebar-container fixed flex flex-col top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700"
             aria-label="Sidebar"
          >
