        ...
        <div className="lg:flex">
          ...
          <div className="mt-8 lg:w-1/2 lg:mt-0">
            <form className="w-full lg:max-w-xl">
              ...
              </div><p className="mt-8 text-xs font-light text-center text-gray-400"> Don't have an account? &nbsp;<a href="#" className="font-medium text-gray-700 dark:text-gray-200 hover:underline">Create One</a></p>
