...
export const metadata: Metadata = {
    title: 'Signup | Task Pro',
    description: 'This is the signup page of Task Pro website.'
}
            ...
            <div className="container px-6 py-24 mx-auto lg:py-32">
                <div className="lg:flex">
                    <div className="lg:w-1/2">
                        ...
                        <h1 className="mt-4 text-gray-600 dark:text-gray-300 md:text-lg">Welcome, Let's create your space</h1>
                    ...
                    <div className="mt-8 lg:w-1/2 lg:mt-0 lg:max-w-xl">
                        ...
                        <p className="mt-4 text-center text-gray-600 dark:text-gray-400 text-xs">By clicking continue, you agree to our Terms of Service and Privacy Policy.</p>
