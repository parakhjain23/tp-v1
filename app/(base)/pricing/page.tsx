...
export const metadata: Metadata = {
    title: 'Pricing | Task Pro',
    description: 'This is the pricing page of Task Pro website.'
}
                        ...
                        <div className="mt-8 space-y-8">
                            ...
                            <div className="flex items-center">
                                <svg className="w-4 h-4 text-red-500" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd" d="M10 20a10 10 0 1 1 0-20 10 10 0 0 1 0 20zm5-11H5v2h10V9z" clipRule="evenodd" />
                                </svg>
