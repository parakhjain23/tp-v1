...
export const metadata: Metadata = {
  title: 'Login | Task Pro',
  description: 'This is the login page of Task Pro website.'
}
      ...
      <div className="container px-6 py-24 mx-auto lg:py-32">
        <div className="lg:flex">
          <div className="lg:w-1/2">
            ...
            <h1 className="mt-4 text-gray-600 dark:text-gray-300 md:text-lg">Welcome back, Join your space</h1>
          ...
          <div className="mt-8 lg:w-1/2 lg:mt-0 lg:max-w-xl">
            <form className="w-full">
              ...
              <a href="#" className="flex mt-2 text-center justify-end text-sm text-blue-300 dark:text-blue-400 hover:underline">Forget Password?</a>
            ...
            <p className="mt-8 text-xs font-light text-center text-gray-400"> Don't have an account? &nbsp;<Link href={'signup'} legacyBehavior={true}><a className="font-medium text-gray-700 dark:text-gray-200 hover:underline">Create One</a></Link></p>
